    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="row">
          <div class="col-md-12">
            <div class="table-responsive">
                ...
                <table
                    ...
                    id="dashActivityReport"
                    class="table table-striped snipe-table"
                    data-url="{{ route('api.upcomming.expired.insurances', ['limit' => 50]) }}">
                    <thead>
                    <tr>
                        <th class="col-sm-3" data-visible="true" data-field="asset_id">{{ trans('general.asset') }}</th>
                        <th class="col-sm-2" data-visible="true" data-field="vendor_id">{{ trans('general.vendor_id') }}</th>
                        <th class="col-sm-2" data-visible="true" data-field="insurance_from">{{ trans('general.insurance_from') }}</th>
                        <th class="col-sm-2" data-visible="true" data-field="insurance_to">{{ trans('general.expiry_date') }}</th>
                    </tr>
                    </thead>
                </table>
          ...
          <div class="text-center col-md-12" style="padding-top: 10px;">
            <a href="{{ url('/insurance/index?target=upcoming_expires') }}" class="btn btn-primary btn-sm" style="width: 100%">{{ trans('general.viewall') }}</a>
          </div>
        </div><!-- /.row -->
      </div><!-- ./box-body -->
    </div><!-- /.box -->
