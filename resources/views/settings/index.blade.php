    ...
    <div class="list clearfix">
        ...
        <div class="col-md-4 col-lg-3 col-sm-6 col-xl-1">
          <div class="box box-default">
            <div class="box-body text-center">
              <h5>
                <a href="{{ route('settings.cashlimit.index') }}" class="settings_button">
                  <i class="fas fa-euro fa-4x" aria-hidden="true"></i>
                  <br><br>
                  <span class="name">Set Cash Limit</span>
                </a>
              </h5>
              <p class="help-block">Cash Limit for Drivers</p>
            </div>
          </div>
        </div>
