 ...
 public function updateProfile(Request $request, $id)
    {
        ...
        try {
            $validatedData = $request->validate([
                ...
                'id_card_front' => 'nullable|mimes:jpeg,jpg,png,gif,bmp,webp,svg,pdf|max:5120',
                'id_card_back' => 'nullable|mimes:jpeg,jpg,png,gif,bmp,webp,svg,pdf|max:5120',
                'driving_license_local' => 'nullable|mimes:jpeg,jpg,png,gif,bmp,webp,svg,pdf|max:5120',
                'driving_license_international' => 'nullable|mimes:jpeg,jpg,png,gif,bmp,webp,svg,pdf|max:5120',
                'maltese_driving_license' => 'nullable|mimes:jpeg,jpg,png,gif,bmp,webp,svg,pdf|max:5120',
                'taxi_tag' => 'nullable|mimes:jpeg,jpg,png,gif,bmp,webp,svg,pdf|max:5120',
                'taxi_tag_back' => 'nullable|mimes:jpeg,jpg,png,gif,bmp,webp,svg,pdf|max:5120',
                'driving_license_local_back' => 'nullable|mimes:jpeg,jpg,png,gif,bmp,webp,svg,pdf|max:5120',
                'driving_license_international_back' => 'nullable|mimes:jpeg,jpg,png,gif,bmp,webp,svg,pdf|max:5120',
                'maltese_driving_license_back' => 'nullable|mimes:jpeg,jpg,png,gif,bmp,webp,svg,pdf|max:5120',
