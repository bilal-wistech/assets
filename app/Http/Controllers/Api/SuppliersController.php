...
class SuppliersController extends Controller
{
    ...
    public function  vendor_create(Request $request)
    {
        ...
        if ($vendor->save()) {
            return response()->json(Helper::formatStandardApiResponse('success', $vendor, 'vendor created successfully.'));
        }
        return response()->json(Helper::formatStandardApiResponse('error', null, $vendor->getErrors()));
    }
}
