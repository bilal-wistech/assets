            ...
            <div class="col-md-12">
              ...
              <table
                    ...
                    <div class="row">
                      ...
                      data-url="{{ route('api.assetRecord', ['item_id' => $asset->id, 'item_type' => 'asset']) }}"
                      data-cookie-id-table="assetRecord"
                      data-cookie="true">
                <thead>
                <tr>
                 
                  <th class="col-sm-2" data-visible="true" data-field="target" data-formatter="usersLinkObjFormatter">{{ trans('general.user') }}</th>
                  <th class="col-sm-1" data-visible="true" data-field="from">{{ trans('general.from') }}</th>
                  <th class="col-sm-1" data-visible="true" data-field="to">{{ trans('general.to') }}</th>
                  <th class="col-sm-2" data-field="note">{{ trans('general.notes') }}</th>
                   <th class="col-sm-1" data-field="note">{{ trans('general.notes') }}</th>
                  <th class="col-sm-1" data-field="location">{{ trans('general.location') }}</th>
