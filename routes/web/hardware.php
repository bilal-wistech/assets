...
Route::group(
    ...
    function () {
        ...
        Route::get('{assetId}/checkout',
            [AssetCheckoutController::class, 'actionCreate']
        ...
        Route::post('bulkcheckout',
            [BulkAssetsController::class, 'storeCheckout']
                ...
                //by usama
        Route::get('{assetId}/createCheckout',[AssetCheckoutController::class, 'actionCreate'])->name('hardware.createcheckout.createCheckout');
        Route::match(['post','get', 'put'], '{assetId}/storeCheckout',[AssetCheckoutController::class, 'actionStore'])->name('hardware.createcheckout.storeCheckout');
        //end usama
